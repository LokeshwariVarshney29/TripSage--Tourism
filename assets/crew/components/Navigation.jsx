...
function Navigation() {
    ...
    return (
        <header className="navbar">
            <NavLink className="nav-brand" to="/Tripsage/signup">
            ...
            <ul className="nav-list">
                <li className="nav-item hover_effect"  id="home">
                    <NavLink className="nav-link" to="/Tripsage">
                        <span className="nav-num">00</span>
                        <span>Home</span>
                    </NavLink>
                </li>
                <li className="nav-item hover_effect"  id="destination">
                    <NavLink className="nav-link" to="/Tripsage/destination/TajMahal">
                        <span className="nav-num">01</span>
                        <span>Destination</span>
                    </NavLink>
                </li>
                <li className="nav-item hover_effect"  id="crew">
                    <NavLink className="nav-link" to="/Tripsage/crew">
                        <span className="nav-num">02</span>
                        <span>Experience</span>
                    </NavLink>
                </li>
                <li className="nav-item hover_effect" id="tech">
                    <NavLink className="nav-link" to="/Tripsage/tech">
